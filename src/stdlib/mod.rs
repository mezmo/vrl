...
cfg_if::cfg_if! {
    if #[cfg(feature = "stdlib")] {
        ...
        stdlib_functions! {
            ...
            mezmo_add_ts_components::MezmoAddTsComponents,
            mezmo_arithmetic_operation::MezmoSubtract,
            mezmo_arithmetic_operation::MezmoMultiply,
            mezmo_arithmetic_operation::MezmoDivide,
            mezmo_char_at::MezmoCharAt,
            mezmo_concat_or_add_fallible::MezmoConcatOrAddFallible,
            mezmo_index_of::MezmoIndexOf,
            mezmo_is_truthy::MezmoIsTruthy,
            mezmo_last_index_of::MezmoLastIndexOf,
            mezmo_length::MezmoLength,
            mezmo_value_size::MezmoValueSize,
            mezmo_matching_patterns::MezmoMatchingPatterns,
            mezmo_map_key_values::MezmoMapKeyValues,
            ...
            mezmo_relational_comparison::MezmoGt,
            mezmo_relational_comparison::MezmoGte,
            mezmo_relational_comparison::MezmoLt,
            mezmo_relational_comparison::MezmoLte,
            mezmo_repeat::MezmoRepeat,
            mezmo_set_ts_components::MezmoSetTsComponents,
